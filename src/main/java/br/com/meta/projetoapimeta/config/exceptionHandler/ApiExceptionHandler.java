...
import br.com.meta.projetoapimeta.config.exceptionHandler.Problema.Campo;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> entidadeNaoEncontradaException(EntityNaoEncontradaException ex, WebRequest request) {
